...
def init():
    ...
    name2path = {
        'and': './ckpts/DatasetAndGate.pth',
        'nand': './ckpts/DatasetNandGate.pth',
        'nor': './ckpts/DatasetNorGate.pth',
        'not': './ckpts/DatasetNotGate.pth',
        'or': './ckpts/DatasetOrGate.pth',
        'xor': './ckpts/DatasetXorGate.pth',
    }
